...
No Bug Bounty, cada tarefa exige atenção — recon, brute force, teste de XSS, análise de JS... Mas é fácil se perder entre abas, notificações ou ficar rodando script sem foco.
